...
$(document).ready(function(){
  ...
  $.ajax({
    url: 'http://localhost/moke/ajax/facebook.php',
    type: 'GET',
    dataType: 'json',
    data: 'url=http://localhost/mokeAndroid/',
    beforeSend: function() {
    ...
    success: function(data) {
      ...
      if(facebook.auth == true)
      {
        ...
        $.ajax({
          url: 'http://localhost/moke/ajax/deezer.php',
          type: 'GET',
          dataType: 'json',
          data: 'url=http://localhost/mokeAndroid/index.html',
          beforeSend: function() {
            /*$("#main article.indenteds.active").removeClass("active");
            $("#main #loading-article").addClass("active");*/
...
function GetMokes(method){
  $.ajax({
    url: 'http://localhost/moke/ajax/ajax_firebase.php',
    type: 'GET',
    dataType: 'json',
    data:'method=' + method,
    beforeSend: function() {
