...
class deezer{
	...
	public function __construct($deezerAppId,$deezerSecret){
		...
		$this->oAuth = "http://connect.deezer.com/oauth/auth.php?app_id=" . $deezerAppId . "&redirect_uri=".urlencode($CONFIG["APIS"]["deezer"]["returnURL"])."&perms=basic_access,email";
		$this->access_token = null;

	}

	public function initialize($code){
		$urlAccessToken = "http://connect.deezer.com/oauth/access_token.php?app_id=" . $this->appId . "&secret=" . $this->secret . "&code=" . $code;
